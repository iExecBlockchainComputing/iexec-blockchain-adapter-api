...
| `IEXEC_CHAIN_ID`                                        | Chain ID of the blockchain network to connect.                                                         | Positive integer | `421614`                                        |
| `IEXEC_IS_SIDECHAIN`                                    | Define whether iExec on-chain protocol is built on top of token (`false`) or native currency (`true`). | Boolean          | `false`                                       |
| `IEXEC_BLOCKCHAIN_NODE_ADDRESS`                         | URL to connect to the blockchain network.                                                              | URL              | `https://sepolia-rollup.arbitrum.io/rpc`                   |
| `IEXEC_BLOCK_TIME`                                      | Duration between consecutive blocks on the blockchain network, in seconds.                             | Positive integer | `5`                                          |
| `IEXEC_HUB_ADDRESS`                                     | Proxy contract address to interact with the iExec on-chain protocol.                                   | Ethereum Address | `0xB2157BF2fAb286b2A4170E3491Ac39770111Da3E` |
